...
int lightLevel, high = 0, low = 1023, capCounter = 0;

Servo gateServo; //Servo control object
...
void setup()
{
  ...
  // We'll now "attach" the servo1 object to digital pin 10.
...
void doButton()
{
  ...
  // Here we'll read the current pushbutton state into
  // a variable
